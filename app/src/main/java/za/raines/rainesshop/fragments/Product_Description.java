package za.raines.rainesshop.fragments;
...
import za.raines.rainesshop.activities.Login;
import za.raines.rainesshop.activities.MainActivity;
import za.raines.rainesshop.adapters.GroupedProductsAdapter;
import za.raines.rainesshop.adapters.ProductAdapter;
import za.raines.rainesshop.adapters.ProductAttributesAdapter;
import za.raines.rainesshop.adapters.ProductReviewsAdapter;
import za.raines.rainesshop.app.App;
import za.raines.rainesshop.constant.ConstantValues;
import za.raines.rainesshop.customs.DialogLoader;
import za.raines.rainesshop.customs.DividerItemDecoration;
import za.raines.rainesshop.databases.User_Favorites_DB;
import za.raines.rainesshop.models.api_response_model.ErrorResponse;
import za.raines.rainesshop.models.cart_model.CartDetails;
import za.raines.rainesshop.models.device_model.AppSettingsDetails;
import za.raines.rainesshop.models.product_model.ProductAttributes;
import za.raines.rainesshop.models.product_model.ProductDetails;
import za.raines.rainesshop.models.product_model.ProductImages;
import za.raines.rainesshop.models.product_model.ProductReviews;
import za.raines.rainesshop.models.seller_detail_model.SellerDetailModel;
import za.raines.rainesshop.models.seller_detail_model.SellerInfoWC;
import za.raines.rainesshop.models.user_model.Nonce;
import za.raines.rainesshop.models.user_model.UserData;
import za.raines.rainesshop.network.APIClient;
import za.raines.rainesshop.utils.DeepLinking;
import za.raines.rainesshop.utils.Utilities;
import za.raines.rainesshop.utils.ValidateInputs;
...
public class Product_Description extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    WebView product_description_webView, product_price_webView, short_description_webView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        short_description_webView  = (WebView) rootView.findViewById(R.id.short_description_webView);
    ...
    private void setProductDetails(final ProductDetails product) {
        ...
        if (productDetails.getShortDescription() == null && TextUtils.isEmpty(productDetails.getShortDescription())) {
            short_description_webView.setVisibility(View.GONE);

        } else {
            short_description_webView.setVisibility(View.VISIBLE);

            String description = productDetails.getShortDescription();
            ...
            short_description_webView.setVerticalScrollBarEnabled(true);
            short_description_webView.setHorizontalScrollBarEnabled(false);
            short_description_webView.setBackgroundColor(Color.TRANSPARENT);
            short_description_webView.setLayerType(WebView.LAYER_TYPE_NONE, null);
            short_description_webView.loadDataWithBaseURL(null, desc_styleSheet + description, "text/html", "utf-8", null);
        }
        ...
        if (productDetails.getDescription() == null && TextUtils.isEmpty(productDetails.getDescription())) {
            ...
            product_description_webView.setVerticalScrollBarEnabled(true);
            ...
            product_description_webView.setLayerType(WebView.LAYER_TYPE_NONE, null);

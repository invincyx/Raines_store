...
import za.raines.rainesshop.customs.EndlessRecyclerViewScroll;
import za.raines.rainesshop.customs.FilterDialog;
import za.raines.rainesshop.models.api_response_model.ErrorResponse;
import za.raines.rainesshop.models.product_filters_model.FilterDetails;
import za.raines.rainesshop.models.product_filters_model.PostFilters;
...
//        isGridView = true;
        ...
        toggleLayoutView.setChecked(isListView);
    ...
    public void setRecyclerViewLayoutManager(Boolean isListView) {
        ...
        productAdapter.toggleLayout(isListView);
        
        all_products_recycler.setLayoutManager(isListView ? linearLayoutManager : gridLayoutManager);
        all_products_recycler.setAdapter(productAdapter);
